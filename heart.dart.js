...
heart.prototype.run = function() {
  ...
  this._intervalId = get$$document().get$window().setInterval(this.get$heartMaker(), (30));
}
heart.prototype.heartMaker = function() {
  ...
  for (var i = (0);
   $lte$(i, get$$window().innerHeight - (150)); i = $add$(i, ((get$$window().innerHeight - (150)) / (20)))) {
    ...
    ctx.fillStyle = $add$($add$($add$("hsl(", i), ",") + $mul$(r, (2)), "%,50%)");
    ctx.font = $add$($add$("", r), "px Arial");
...
(function(){
  ...
  var table = [
    ...
    , ['Node', [v1/*Element*/,'Node|Attr|CharacterData|Comment|Text|CDATASection|HTMLDocument|DocumentFragment|ShadowRoot|DocumentType|Entity|EntityReference|Notation|ProcessingInstruction'].join('|')]
