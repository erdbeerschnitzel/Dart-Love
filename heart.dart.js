...
$$.LinkedHashMapImplementation = {"":
 ...
 getValues$0: function() {
  ...
  t1.list_10 = list;
  t1.index_2 = 0;
  $.forEach(this._list, new $.Closure8(t1));
  return t1.list_10;
 },
 getKeys$0: function() {
  var t1 = ({});
...
$$._Copier = {"":
 ...
 visitMap$1: function(map) {
  ...
  $.forEach(map, new $.Closure12(this, t1));
  return t1.copy_1;
 },
...
$$._EventLoop = {"":
 ...
 _runHelper$0: function() {
  var t1 = $._window();
  if (!(t1 == null)) new $.Closure13(this).$call$0();
  else {
...
$.invokeClosure = function(closure, isolate, numberOfArguments, arg1, arg2) {
  ...
  if ($.eqB(numberOfArguments, 0)) return $._callInIsolate(isolate, new $.Closure(t1));
  if ($.eqB(numberOfArguments, 1)) return $._callInIsolate(isolate, new $.Closure0(t1));
  if ($.eqB(numberOfArguments, 2)) return $._callInIsolate(isolate, new $.Closure1(t1));
...
$.$defineNativeClass('Storage', [], {
 ...
 getValues$0: function() {
  var values = [];
  this.forEach$1(new $.Closure6(values));
  return values;
 },
 getKeys$0: function() {
  var keys = [];
